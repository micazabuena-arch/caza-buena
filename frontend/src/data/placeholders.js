...
Schedule Flexibility: The tour schedule is highly flexible. You can head out anytime between 7:00 AM and 3:00 PM, and you may return to the wharf whenever you are ready, provided it is no later than 5:00 PM.`,
  ...
  meals: {
    eyebrow: 'Café & Dining',
    title: 'Meals & Menu',
    subtitle: 'Mediterranean-inspired plates, island-day bites, and café favorites by the sea.',
    intro:
      'From sunrise coffee to sunset plates, our café serves fresh flavors with a Santorini touch—perfect after a day on the Hundred Islands.',
    hoursNote: 'Café hours: 7:00 AM – 8:00 PM daily. Menu items and prices may change seasonally.',
    pdfUrl: '/menu.pdf',
    pdfNote: 'Opens the full café menu in PDF format.',
    disclaimer:
      'Menu is for reference only. Dine-in at the café; online meal ordering is not available on this website.',
    items: [
      {
        category: 'Breakfast',
        name: 'Aegean Sunrise Plate',
        description: 'Eggs, grilled tomatoes, olives, feta, and warm bread.',
        price: 280,
        is_featured: true,
      },
      {
        ...
        description: 'Honey, granola, and seasonal fruit.',
        price: 195,
      },
      {
        category: 'All-Day Plates',
        name: 'Santorini Chicken Bowl',
        description: 'Herb chicken, rice, tzatziki, cucumber, and lemon.',
        price: 320,
        is_featured: true,
      },
      {
        category: 'All-Day Plates',
        name: 'Lucap Seafood Pasta',
        description: 'Catch-of-the-day seafood in garlic olive oil sauce.',
        price: 380,
      },
      {
        category: 'All-Day Plates',
        name: 'Mediterranean Veggie Wrap',
        description: 'Grilled vegetables, hummus, and greens in a soft wrap.',
        price: 260,
      },
      {
        category: 'Café & Drinks',
        name: 'Blue Dome Iced Latte',
        description: 'House espresso with vanilla and blue butterfly pea.',
        price: 165,
        is_featured: true,
      },
      {
        category: 'Café & Drinks',
        name: 'Island Sunset Smoothie',
      ...
      },
      {
        ...
        description: 'Chilled and lightly sweetened.',
        price: 95,
      },
      {
        category: 'Desserts',
        name: 'Baklava Bites',
        description: 'Honey-nut pastry with cinnamon.',
        price: 145,
      },
      {
        category: 'Desserts',
        name: 'Salted Caramel Gelato',
        description: 'Creamy gelato with sea-salt caramel swirl.',
        price: 135,
      },
    ],
  },
